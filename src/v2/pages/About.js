    ...
    <div style={containerStyles} className="v2-fade-in">
      ...
      <div style={cardStyles}>
        <p style={contentStyles}>
          We are Sports Fans and this will be your future home of your local leagues with friends.
          Click on I'm Feeling Lucky button to generate some of your lucky numbers and symbols.
        </p>
      </div>
    </div>
  );
