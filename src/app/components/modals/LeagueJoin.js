        ...
        <form onSubmit={handleSubmit}>
          <div className="grid lg:grid-cols-1 gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <Password required id="password" type="text" value={password} inputClassName="w-full" placeholder="Password" toggleMask={false} feedback={false} onChange={(e) => setPassword(e.target.value)} className="text-sm"/>
            </div>
