...
export default function ClerkLogin() {
  return (
    ...
    <div className="grid md:grid-cols-2 items-center gap-1 min-h-screen">
      ...
      <div className="flex flex-col m-auto w-full h-full bg-cover flex items-center justify-center bg-center bg-no-repeat bg-[url('https://goatsportspools.com/img/logo_expanded.png')] md:w-full md:bg-none bg-background md:bg-white">
        <SignIn fallbackRedirectUrl={'main?page=dashboard'} />
      </div>
    </div>
  )
}