...
export default function ClerkLogin() {
  ...
  return (
    ...
    <div className="grid md:grid-cols-2 items-center gap-1 min-h-screen">
      <div className={`rounded-tr-[100px] rounded-br-[100px] relative hidden bg-background bg-cover bg-center bg-no-repeat bg-[url(https://goatsportspools.com/img/newlogo_2.png)] h-full flex-col md:flex md:shrink md:w-full m-auto`}>
      ...
      <div className="p-5 flex flex-col m-auto w-full h-full bg-cover gap-2 flex items-center justify-center bg-center bg-no-repeat bg-[url('https://goatsportspools.com/img/newlogo_2.png')] md:w-full md:bg-none bg-background md:bg-white">
